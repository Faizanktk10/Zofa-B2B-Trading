    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LeadUnlockId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadUnlocks", x => x.LeadUnlockId);
                    table.ForeignKey(
                        name: "FK_LeadUnlocks_RFQs_RFQId",
                        column: x => x.RFQId,
                        principalTable: "RFQs",
                        principalColumn: "RFQId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadUnlocks_Users_SupplierId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "IconUrl", "Name", "ParentId", "Slug" },
                values: new object[,]
                {
                    { 1, null, "Scrap", null, "scrap" },
                    { 2, null, "Textile", null, "textile" },
                    { 3, null, "Agriculture", null, "agriculture" },
                    { 4, null, "Machinery", null, "machinery" },
                    { 5, null, "Packaging", null, "packaging" },
                    { 6, null, "Raw Materials", null, "raw-materials" },
                    { 7, null, "Chemicals", null, "chemicals" },
                    { 8, null, "Electronics", null, "electronics" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "City", "CompanyName", "CreatedAt", "Email", "FullName", "IsActive", "IsVerified", "PasswordHash", "Phone", "Province", "Role" },
                values: new object[] { 1, null, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@zofa.pk", "Admin", true, true, "$2a$11$LfDq.DpxWnWNGYf9Kx.nB.WfY1ScX0G2doKoasrajE8VMyKWzG5eG", null, null, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadUnlocks_RFQId",
                table: "LeadUnlocks",
                column: "RFQId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadUnlocks_SupplierId",
                table: "LeadUnlocks",
                column: "SupplierId");
